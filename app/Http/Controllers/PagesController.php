...
class PagesController extends Controller
{
    ...
    public function pay(Request $request)
    {
        ...
        $user = $this->user;
        header('Location: https://api.gdonate.ru/pay?public_key=ec2b0-2208&sum=10&account=demo&desc=Описание+платежа'.\App\Http\Controllers\GameController::GDonateKeyPublic.'&sum='.$amount.'&account='.$user->id.'&desc=Пополнение баланса на CSGODICH.RU');
        exit();
    }
}
