...
{
    const BOT_TRADE_LINK = 'https://steamcommunity.com/tradeoffer/new/?partner=38580168&token=INNv2bnF'; #Ссылку на трейд Бота.
    ...
    const API_KEY = '57e55546c44045459c1bcd6a'; # Ключ для сайта backpack.tf

    const GDonateKeyPublic = '03b45-2208';
    const GDonateKey = '2d781bd6d699efef784a480096befc18';
	...
	const SITENAME = 'CSGO-BEEN.RU';        # Название сайта
	const LINKVK = 'https://vk.com/mrshoka';        #Ссылку на группу вк.
	const SITELOGO = '/assets/img/logo-ru.png'; #Логотип.
	const FAVICON = '/favicon.png'; #Favicon.
     ...
     public function currentGame()
    {
        ...
        $lastava = '/assets/img/unknown.jpg';
        $lastchanc = '???';
        $lastprice = '???'; 
        }
        #LAST WINNER#
        ...
        $luckyava = '/assets/img/unknown.jpg';
        $luckychanc = '???';
        $luckyprice = '???';
        }
        #LUCKY WINNER#
        ...
        $allluckyava = '/assets/img/unknown.jpg';
        $allluckychanc = '???';
        $allluckyprice = '???';
        }
        #ALLLUCKY WINNER#

        return view('pages.index', compact('game', 'bets', 'user_chance', 'chances', 'user_items', 'lastname', 'lastava','lastchanc', 'lastprice', 'luckyname', 'luckyava', 'luckychanc', 'luckyprice', 'allluckyname', 'allluckyava', 'allluckychanc', 'allluckyprice'));
    }
