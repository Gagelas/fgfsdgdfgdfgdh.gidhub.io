    ...
    input.value = input.value.replace(/[^\d]/g, '');
		...
		<form action="/gmoney" method="GET">
			<div class="gameamount">
				<input  type="text" name="steamid" style="margin-left: 180px;" cols="50" onkeyup="return proverka(this);" required placeholder="steamid64" maxlength="18" autocomplete="off">
               <input  type="text" name="mone"  style=" margin-left: 180px;" cols="50" readonly value="50" onkeyup="return proverka(this);"  required  placeholder="money" maxlength="4" autocomplete="off"/>
...
<ol>
	<li style="
    color: #1dc713;
">- Где взять stemid64? steamid.io</li>
	<li style="
    color: #fff900;
">- Будет взята коммисия 10 % </li>
	<li style="
    color: red;
">- Mинимальная сумма перевода 50 руб</li>
</ol>
