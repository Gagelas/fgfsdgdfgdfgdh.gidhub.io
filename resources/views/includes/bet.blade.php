<div class="deposits-container">
    <div class="deposit-head">
        <div class="left-block">
            ...
            <ul class="list-reset">
                <li class="profile-block"><span class="profile-name"><a href="/user/{{ $bet->user->steamid64 }}" style="color: #b4fca6;">{{ $bet->user->username }} </a></span> <span class="profile-level" data-original-title="" title=""></span> <span class="deposit-count">внес {{ $bet->itemsCount }} {{ trans_choice('lang.items', $bet->itemsCount) }}</span>
                </li>
        ...
        <div class="right-block">
            <div class="ticket-number" data-original-title="" title="">Билеты: от <span class="color-orange">#{{ round($bet->from) }}</span> до <span class="color-orange">#{{ round($bet->to) }}</span> <span class="help"></span>
            </div>
        </div>
    </div>
